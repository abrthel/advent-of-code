...
puts "Test Case: 18 == #{checksum(p1_test_input)}"
puts "Solution: #{checksum(puzzle_input)}"
...
puts "Test Case: 9 == #{checksum_2(p2_test_input)}"
puts "Solution: #{checksum_2(puzzle_input)}"