...
def valid_passphrase_2?(input)
  input
    .split("\n")
    .count {|phrase|
      words = phrase
                .split
                .map{|x| x.chars.sort.join}
      words.uniq == words
    } 
end
...
puts "Test Case: 1 == #{valid_passphrase?("aa bb cc dd ee")}"
puts "Test Case: 0 == #{valid_passphrase?("aa bb cc dd aa")}"
puts "Test Case: 1 == #{valid_passphrase?("aa bb cc dd aaa")}"
puts "Solution: #{valid_passphrase?(puzzle_input)}"


puts "\n\n  Part Two"
puts "(exp == act)\n"

puts "Test Case: 1 == #{valid_passphrase_2?("abcde fghij")}"
puts "Test Case: 0 == #{valid_passphrase_2?("abcde xyz ecdab")}"
puts "Test Case: 1 == #{valid_passphrase_2?("a ab abc abd abf abj")}"
puts "Test Case: 1 == #{valid_passphrase_2?("iiii oiii ooii oooi oooo")}"
puts "Test Case: 0 == #{valid_passphrase_2?("oiii ioii iioi iiio")}"
puts "Solution: #{valid_passphrase_2?(puzzle_input)}"